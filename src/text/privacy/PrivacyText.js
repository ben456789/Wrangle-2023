      ...
      <div className="container">
        <div className={styles.legalContent__col}>
          ...
          <p>
            ...
            when you sign up to our newsletter, download of the Wrangle app or
          ...
          <p>This version was last updated on 26th August 2019.</p>
          <p>
            The data protection law in the UK will change on 25 May 2018.
            Although this privacy notice sets out most of your rights under the
            new laws, we may not yet be able to respond to some of your requests
            (for example, a request for the transfer of your personal data)
            until May 2018 as we are still working towards getting our systems
        ...
        <div className={styles.legalContent__col}>
          ...
          <ul>
            ...
            <ul>
              ...
              <li>leave a product review; or </li>
            ...
            <ul>
              ...
              <ul>
                <li>
                  (a) analytics providers such as Google and Adobe based inside
                  the EU;
                </li>
                <li>
                  (b) advertising networks [such as Google or Facebook based
                  inside the EU; and
                </li>
              </ul>
              <li>
              ...
              <li>
                ...
                as Companies House based inside the EU.
              </li>
            </ul>
          </ul>
        </div>
        ...
        <div className={styles.legalContent__col}>
          ...
          <p>
            ...
            data. These rules are called "binding corporate rules". For further
            details, see European Commission: Binding corporate rules.
          </p>
           
          <p>
        ...
        <div className={styles.legalContent__col}>
          ...
          <p>
            ...
            data can be requested from us by contacting us 
          </p>
          <p>
            In some circumstances you can ask us to delete your data: see 
            <a href="#erasure">Request erasure</a> below for further
            information. {" "}
          </p>
          <p>
        ...
        <div className={styles.legalContent__col}>
          ...
          <ul>
            <li>
              ...
              <br />
              <br />
              This is commonly known as a "data subject access request". This
              enables you to receive a copy of the personal data we hold about
              you and to check that we are lawfully processing it.
              <br />
              <br />  To request this please email 
              <a href="mailto:datarequests@wrangleapp.io">
                datarequests@wrangleapp.io
              </a>{" "}
              and specify you would like access to your data.
            </li>
            <li>
              ...
              the new data you provide to us.  <br />
              <br />
              To request correction to your data please please email 
              <a href="mailto:datarequests@wrangleapp.io">
                datarequests@wrangleapp.io
              </a>
            </li>
            <li>
              ...
               and specify you would like us to delete your data.
            </li>
            <li>
              Object to processing of your personal data.  You can object to
              ...
              compelling legitimate grounds to process your information  To
              request correction to your data please email 
              <a href="mailto:datarequests@wrangleapp.io">
                datarequests@wrangleapp.io
              </a>
            </li>
            <li>
              Request restriction of processing  <br />
              <br />
              ...
              <br />
              <br />
              To request correction to your data please email a
              href="mailto:datarequests@wrangleapp.io"&gt;datarequests@wrangleapp.io
            </li>
            <li>
              Request transfer of your personal data.  <br />
              <br />
              You can request the transfer of your personal data to you or to a
              ...
              <br />
              <br />
              To request correction to your data please email 
              <a href="mailto:datarequests@wrangleapp.io">
                datarequests@wrangleapp.io
              </a>
            </li>
            <li>
              ...
              time you withdraw your consent.  To request correction to your
              data please email 
              <a href="mailto:datarequests@wrangleapp.io">
                datarequests@wrangleapp.io
              </a>
        ...
        <div className={styles.legalContent__col}>
          ...
          <ul>
            ...
            <li>
              ...
              including lawyers, bankers, auditors and insurers based in the EU
        ...
        <div className={styles.legalContent__col}>
          ...
          <div className="terms-closing">
            ...
            <p>
              <b>Registered number:</b> 12189184{" "}
            </p>
          </div>
        </div>
      </div>
